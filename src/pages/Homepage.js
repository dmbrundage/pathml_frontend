 ...
 */
  ...
  return (
   ...
   processedtilehandler = {this.processedtilehandler} tilehandler = {this.tilehandler} regionsize={this.state.region_size} iterations={this.state.iterations}
   filenamehandler = {this.filenamehandler} filename={this.state.filename} imagename={this.props.imagename}/>
<Container>
...
<Grid item xs={4}>
   ...
   regionsize={this.state.region_size} iterations={this.state.iterations} regionsizehandler={this.regionsizehandler} iterationshandler={this.iterationshandler}/>
      ...
      <Grid item xs={6}>
      {this.state.processed_tiles.length >1 
